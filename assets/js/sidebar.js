...
export function sidebar() {
    ...
    //es movie list me Bengali extra add kiya hai aapne maan se line 37 me pahle Bengali language nahi tha add
    ...
    sidebarInner.innerHTML = `
        ...
        <div class="sidebar-list">
            ...
            <a href="./movie-list.html" menu-close class="sidebar-link" onclick='getMovieList("with_original_language=mr", "Marathi")'
                >Marathi</a
            >
            <a href="./movie-list.html" menu-close class="sidebar-link" onclick='getMovieList("with_original_language=be", "Bengali")'
                >Bengali</a>
        </div>
        <div class="sidebar-footer">
            <p class="copyright">
                Copyright 2024
                <a href="https://www.linkedin.com/in/pankaj-kumar-909287289/">Pankaj Kumar</a>
                <img
